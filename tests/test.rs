...
fn t_test_som() {
    ...
    // Floor no longer 0 with uniform dist initialized som
...
fn t_test_size() {
    let classes: Vec<String> = Vec::new();
    let map = SOM::create(2, 3, 5, Some(rusticsom::DistType::Uniform), classes, Some((0.0, 1.0)), Some(0.1), None, None, None);
...
fn t_distance_map(){
    let classes: Vec<String> = Vec::new();
    let mut map = SOM::create(2, 3, 5, Some(rusticsom::DistType::Uniform), classes, Some((0.0, 1.0)), Some(0.1), None, None, None);
...
fn t_full_test() {
    ...
    let classes: Vec<String> = Vec::new();
    let mut map = SOM::create(10, 10, 4, Some(rusticsom::DistType::Uniform), classes, Some((0.0, 1.0)), None, None, None, None);
